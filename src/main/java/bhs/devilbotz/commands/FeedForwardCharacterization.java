...
import bhs.devilbotz.utils.PolynomialRegression;
...
/**
 * Command to get generate characterization values
 * <p>
 * Due to the robot being swerve, SYSID cannot be used (Thankfully), so a command
 * must be used.
 *
...
public class FeedForwardCharacterization extends CommandBase {
     ...
     *
     * @param drive     The {@link Drive} subsytem to execute velocity with
     * @param forwards  If the robot shall drive forwards or backwards
     * @param leftData  The primary data
     * @param rightData The secondary data
     */
    ...
    public static class FeedForwardCharacterizationData {
        ...
        public void print() {
            ...
            System.out
                    .println("\tCount=" + velocityData.size());
